...
import com.rsz.foodapp.BuildConfig
import com.rsz.foodapp.FoodApp
import com.rsz.foodapp.helper.Helpers
...
class HttpClient {
    ...
    private fun buildRetrofitClient() {
        val token = FoodApp.getApp().getToken()
    ...
    fun buildRetrofitClient(token: String?) {
        ...
        if (BuildConfig.DEBUG) {
            ...
            builder.addInterceptor(ChuckInterceptor(FoodApp.getApp()))
        }
